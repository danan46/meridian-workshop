      ...
      <div v-if="isOpen && costData" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ costData.month }} {{ t('modal.costDetail.titleSuffix') }}</h3>
          ...
          <div class="modal-body">
            <div class="cost-summary">
              <div class="summary-card total">
                <div class="summary-label">{{ t('modal.costDetail.totalCosts') }}</div>
            ...
            <div class="cost-breakdown">
              <div class="cost-item procurement">
                ...
                <div class="cost-percentage">{{ getProcurementPercentage() }}{{ t('modal.costDetail.ofTotal') }}</div>
              </div>
              ...
              <div class="cost-item operational">
                ...
                <div class="cost-percentage">{{ getOperationalPercentage() }}{{ t('modal.costDetail.ofTotal') }}</div>
              </div>
              ...
              <div class="cost-item labor">
                ...
                <div class="cost-percentage">{{ getLaborPercentage() }}{{ t('modal.costDetail.ofTotal') }}</div>
              </div>
              ...
              <div class="cost-item overhead">
                ...
                <div class="cost-percentage">{{ getOverheadPercentage() }}{{ t('modal.costDetail.ofTotal') }}</div>
              </div>
            </div>
          </div>
