      ...
      <div v-if="isOpen && product" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('modal.productDetail.title') }}</h3>
          ...
          <div class="modal-body">
            ...
            <div class="info-grid">
              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.category') }}</div>
                <div class="info-value">{{ product.category }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.warehouse') }}</div>
                <div class="info-value">{{ product.warehouse }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.unitsOrdered') }}</div>
                <div class="info-value">{{ product.unitsOrdered }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.totalRevenue') }}</div>
                <div class="info-value">{{ currencySymbol }}{{ product.revenue.toLocaleString() }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.currentStock') }}</div>
                <div class="info-value">{{ product.quantityOnHand }} units</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.reorderPoint') }}</div>
                <div class="info-value">{{ product.reorderPoint }} units</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.firstOrderDate') }}</div>
                <div class="info-value">{{ formatDate(product.firstOrderDate) }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.productDetail.stockStatus') }}</div>
